...
class Triangle(object):
    ...
    def __init__(self):
#            line = "(0.556 0.000 0.000) (0.006 0.000 0.559) (0.556 0.000 0.559)  (0.7 0.7 0.7) (0 0 0)"
#        line = "(0.343 0.545 0.332) (0.213 0.545 0.227) (0.343 0.545 0.227) (0.7 0.7 0.7) (0 0 0)"
	line = "(0.006 0.0 0.559) (0.556 0.0 0.0) (0.006 0.0 0.559) (0.7 0.7 0.7) (0.0 0.0 0.0)"
	v0, v1, v2, r, e = SEARCH(line).groups()
	self.vertexs = map(Vector3f, [v0, v1, v2])
	self.edge0 = Vector3f(v1) - Vector3f(v0)
	self.edge3 = Vector3f(v2) - Vector3f(v0)
